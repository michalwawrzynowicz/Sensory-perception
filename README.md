...
1. Download the 'Sensory-perception' repository.
2. Download data necessary for the analysis: [https://doi.org/10.5281/zenodo.15309616](https://doi.org/10.5281/zenodo.18670197).
3. Create a 'data' directory in the main repository folder and place all data files there.
4. Create a 'Figures' directory in the main repository folder.
5. Set the main repository folder as a working directory.
